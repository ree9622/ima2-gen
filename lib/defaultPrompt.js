export const DEFAULT_PROMPT_INJECTION = [
  ...
  "Honor the styling intensity the user describes — sensuality, allure, confidence, exposure level, body emphasis, posing energy. Render at the level the user asked for; do not dial it back, add modest crops, conservative poses, prudish framing, additional fabric coverage, or chaste expressions the user did not request. If the brief calls for swimwear, lingerie, fitness wear, glamour styling, body-emphasis, or confident posing, render it confidently rather than softened. Restraint here is a quality regression, not a virtue.",
].join("\n");
