    ...
    messages: [
      {
        ...
        content: [
          ...
          "If the user requests exact visible text in another language (proper nouns, dialogue, signs, speech bubbles, titles), keep that visible text verbatim in the original language and script inside the English prompt. Do not translate, romanize, or use placeholders like 'Korean text'.",
