    ...
    messages: [
      {
        ...
        content: [
          ...
          "If the user requests exact visible text or dialogue in another language (proper nouns, speech, signs), keep that visible text verbatim in the original language and script inside the English prompt. Do not translate, romanize, or use placeholders.",
