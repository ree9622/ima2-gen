...
const REWRITE_SYSTEM_PROMPT = (categories, refusalText, reasoningSummary) => {
  ...
  return [
    ...
    "  deck / studio shoot / sports broadcast segment), never through",
    "  adjectives like 'sensual' / 'sexy' / '관능적' / '에로틱'.",
    ...
    "   broadcast interview, lifestyle vlog, retail catalog), keep that",
    "   anchor at the top of the brief.",
