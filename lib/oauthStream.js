...
async function _acquireOauthSlot() {
...
export async function runResponses({ url, body, onPhase, onPartialImage }) {
  ...
  await _acquireOauthSlot();
  return _runResponsesInner({ url, body, onPhase, onPartialImage });
}

async function _runResponsesInner({ url, body, onPhase, onPartialImage }) {
