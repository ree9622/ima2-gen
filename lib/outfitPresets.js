...
export const OUTFIT_PRESETS = [
  ...
  // UI: maxRisk = "high" 체크 시에만 풀에 포함됨 (default medium 유지).
  {
    ...
    risk: "high",
    outfit:
      "high-leg cut two-piece summer swimwear in a vibrant solid color, " +
      "hip line riding very high above the waist exposing the full hip and side, " +
      "scooped neckline open across the décolletage area, " +
      "shoulders and full arms uncovered, " +
      "complete bare midriff from rib cage down to hipbone visible, " +
      "string ties at both hips, posing by an outdoor pool",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "string-tie two-piece summer swimwear in a soft pastel color, " +
      "top tied at the back of the neck and across the upper back, " +
      "bottoms tied at both hipbones with the side strings hanging down, " +
      "hip line riding low on the hipbone, complete bare midriff visible, " +
      "shoulders, full arms, and full back uncovered, " +
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "minimal-coverage two-piece summer swimwear in a vibrant solid color, " +
      "very narrow top with thin shoulder straps, very small bottom riding " +
      "low at the hipbone with high-leg cut at both sides, " +
      "complete bare midriff, complete bare lower back, full hip line and " +
      "full thigh line visible, shoulders and arms uncovered",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "deeply scooped fitted ribbed crop tank top in a solid color, " +
      "neckline scooped down to mid-chest level showing the full décolletage area, " +
      "thin shoulder straps with shoulders and full arms uncovered, " +
      "hem cropped well above the navel showing complete midriff and lower rib line, " +
      "low-rise short mini skirt riding very low on the hipbone at upper-thigh length, " +
      "full hip line and full thigh line visible",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "fitted halter-neck mini dress in soft satin, hem at upper-thigh length, " +
      "deeply scooped front neckline open across the décolletage area, " +
      "back cut completely open from the nape down to the lower back showing " +
      "the full bare back, thin shoulder straps tied at the nape, " +
      "shoulders and full arms uncovered, full leg line from upper thigh visible",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "one-piece summer swimwear in a vibrant solid color with both side panels cut " +
      "completely open from under the bust down to the hipbone, " +
      "exposing the full side waist and side ribs, " +
      "deep front neckline scooped across the décolletage, " +
      "high-leg cut at both hips riding very high above the waistline, " +
      "shoulders, full arms, and full back uncovered",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "fitted lounge bodysuit in a solid color with deeply scooped front neckline " +
      "down to mid-chest, very high-leg cut at both hips above the waistline, " +
      "thin shoulder straps with shoulders and arms uncovered, " +
      "complete leg line from hipbone down visible, " +
      "trying it on inside a clothing store interior with full-length mirror reflection",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "string-tie two-piece summer swimwear in a vibrant solid color, " +
      "currently re-tying the top string behind the neck with both arms reaching back, " +
      "elbows lifted high revealing complete underarm and side rib line, " +
      "complete bare midriff, complete bare lower back, " +
      "high-leg cut bottoms riding low on the hipbone with side strings hanging",
    emphasis:
  ...
  },
  {
    ...
    outfit:
      ...
      "lying face-down on a wooden sun-deck chair so the bare back is fully visible " +
      "from shoulders to the lower back waistline, " +
      "high-leg cut bottoms riding low at the hip exposing full hip line and side waist",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "soft white short bath towel wrapped low around the body, " +
      "wrap riding low across the upper hip line so the entire upper body above " +
      "the chest is uncovered down to just above the bust line, " +
      "towel hem at upper-thigh length, shoulders, full arms, full back uncovered, " +
      "hair fully wet with damp strands resting on the bare shoulders",
    emphasis:
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "fitted lounge crop top with very narrow shoulder straps, currently adjusting " +
      "one shoulder strap by pulling it outward with one finger, " +
      "deeply scooped neckline open across the décolletage area, " +
      "hem cropped well above the navel showing complete midriff and lower rib line, " +
      "matching low-rise lounge briefs riding very low on the hipbone with high-leg cut, " +
      "shoulders, full arms, and full back uncovered",
    emphasis:
  ...
  },
  {
    ...
    outfit:
      ...
      "hip line riding very high above the waistline, " +
      "deep scoop neckline open across the décolletage area, " +
      "shoulders, full arms, complete bare midriff, full hip line, " +
      "and full leg line visible, " +
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "minimal-coverage string-tie two-piece swimwear in a soft pastel color, " +
      "high-leg cut at both hips, complete bare midriff and full hip line visible, " +
      "deep scoop neckline, shoulders and full arms uncovered, " +
  ...
  },
  {
    ...
    risk: "high",
    outfit:
      "fitted athletic crop sports top with deeply scooped neckline open across the " +
      "décolletage area, very narrow shoulder straps, hem cropped well above the navel " +
      "showing complete midriff with abdominal definition, " +
      "high-rise body-hugging short athletic shorts riding very high on the leg, " +
      "side-cut high above the hipbone exposing the full hip line and full thigh line, " +
...
export function composeOutfitPrompt(module, opts = {}) {
  ...
  const effectiveOpts = isMedia
    ? { ...opts, aspectRatio: BROADCAST_ASPECT_RATIO_LABEL }
    : opts;
