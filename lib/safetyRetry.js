...
// Extend the 2-variant base sequence (original, compliant) into N total attempts.
// For N > 2: alternate between variants (safety refusals won't change with the
// same prompt, but network/5xx/transient errors benefit from repeating).
// Falls back to the original prompt if no compliant variant is available.
