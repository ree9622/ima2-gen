...
- 2026-05-30: Updated the structure set for the `ima2-gen@1.1.15` Grok publish surface: `--provider <auto|oauth|api|grok>`, `ima2 grok`, prompt-builder CLI wrapper, capabilities discovery, bundled progrok env vars, GitHub Pages contract sync, and the explicit image-only/no-video runtime scope.
