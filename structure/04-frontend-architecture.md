...
- 2026-05-30: Recorded the 1.1.15 Grok UI contract: workspace/provider settings can choose Grok alongside OAuth/API, Agent Mode uses the same Grok search + planner + xAI Images API path as Classic/Node, and GitHub Pages documents the image-only/no-video scope.
